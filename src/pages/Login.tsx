  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[color:var(--bg)] px-6 text-[color:var(--text)]">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--bg-elev)] p-7">
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            <div>
              <label className="mb-1.5 block text-xs font-medium uppercase tracking-wide text-[color:var(--text-dim)]">Work email</label>
              <input
                value={email}
            ...
            <div>
              <label className="mb-1.5 block text-xs font-medium uppercase tracking-wide text-[color:var(--text-dim)]">Password</label>
              <input
                type="password"
                value={password}
            ...
            <button
              type="submit"
              className="w-full rounded-full bg-[color:var(--accent)] py-2.5 text-sm font-bold text-black transition hover:brightness-110"
            >
              Log in
            </button>
          </form>
