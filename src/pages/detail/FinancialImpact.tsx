  ...
  return (
    <div className="space-y-10">
      <section className="space-y-6">
        <h2 className="text-xs font-bold uppercase tracking-widest text-[color:var(--text-dim)]">Cost of quiet operation</h2>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="border-[color:var(--accent-2)]/25">
            <CardTitle>Projected avoided mitigation cost <span className="ml-2 rounded-full bg-[color:var(--accent-2)]/12 px-2 py-0.5 text-[10px] font-bold uppercase text-[color:var(--accent-2)]">Stretch estimate</span></CardTitle>
              ...
              {(['hour', 'day', 'week'] as const).map((r) => (
                <button
                  ...
                  className={`rounded-full px-3 py-1 text-xs font-semibold ${
                    range === r ? 'bg-[color:var(--accent)]/12 text-[color:var(--accent)]' : 'text-[color:var(--text-dim)] hover:text-[color:var(--text)]'
                  }`}
                >
                  {r}
                </button>
      ...
      <section className="space-y-6">
        <h2 className="text-xs font-bold uppercase tracking-widest text-[color:var(--text-dim)]">Legal compliance monitoring</h2>
